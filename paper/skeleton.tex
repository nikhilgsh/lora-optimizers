...
\Phase{Momentum} (bias-corrected)
\State $M_A\gets\beta_1 M_A+(1-\beta_1)\,G_A$, \qquad $\hat M_A\gets M_A/(1-\beta_1^{\,t})$
\State $M_B\gets\beta_1 M_B+(1-\beta_1)\,G_B$, \qquad $\hat M_B\gets M_B/(1-\beta_1^{\,t})$
