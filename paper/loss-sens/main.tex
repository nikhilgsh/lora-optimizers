...
\end{restatable}
Secondly, we note that when measured in an appropriate norm, the size of sample gradients is bounded with high probability. Define $\mat{\Sigma}$ to be the second moment of the gradients and $\|\cdot\|_{\mat{\Sigma}}$ to be the associated Mahalanobis norm
