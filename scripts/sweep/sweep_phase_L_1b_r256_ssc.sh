#!/bin/bash
# Phase L (long-horizon 1B) at r=256 with SSC fixed-κ plumbing for
# chord-tight-clean. Clone of sweep_phase_L_1b_r64_ssc.sh with lora_r/alpha
# bumped to 256. Picard=2 (κ<1 only departs from polar at k≥2 per
