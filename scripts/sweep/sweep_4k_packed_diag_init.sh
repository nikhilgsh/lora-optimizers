#!/bin/bash
# 4000-step single-pass sweep with diagnostics, extended with a lora_init_b
# positional arg (zero/gaussian/symmetric). Mirrors sweep_4k_packed_diag.sh
# otherwise. Used for the Init[AB] follow-up at r=256.
#
...
#   4: seed (default 0)
#   5: lora_r (default 256)
#   6: lora_init_b (default symmetric)
lr=${1:-1e-2}
optimizer=${2:-adam-polar-product-lora-coupled-spectral-chord-tight}
lora_plus_multiplier=${3:-1.0}
seed=${4:-0}
lora_r=${5:-256}
lora_init_b=${6:-symmetric}
