#!/bin/bash
# AdamW-8B baseline (speed target): Meta-Llama-3-8B × opc-sft-stage2
# × seq=2048 × global_batch=16 × r=256 × packed_v1.1.
#
# This is the MANDATORY AdamW speed-target sweep that must precede any
# chord-tight-8B comparison (leaderboard metric is speed-to-AdamW-target).
#
