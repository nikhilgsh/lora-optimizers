#!/bin/bash
# NESTEROV-lookahead ablation: r64 opc PE=8 k=1 with Nesterov momentum enabled.
# Rank-generalization arm of the r256 opc nesterov test. Baseline (plain EMA):
# diag_shampoo_polar_r64_opc_pe8_blackwell.
...
curvature_beta=0.99   # fixed (was 6th positional)
