...
### Bench cells (Blackwell, packed_v1)
...
| tier | r   | seq  | batch×accum | optim              | fwd ms | bwd ms | opt ms | total ms |  MFU  | peak MB |
|------|----:|-----:|-------------|--------------------|-------:|-------:|-------:|---------:|------:|--------:|
| 1B   |  64 | 2048 | 2×8         | adamw              |    606 |   1042 |    3.2 |     1652 | 48.3% |   14807 |
| 1B   |  64 | 2048 | 2×8         | tight-chord-higham |    607 |   1042 |   42.1 |     1693 | 47.1% |   15178 |
| 1B   | 256 | 2048 | 2×8         | adamw              |    784 |   1328 |   10.4 |     2124 | 41.1% |   17351 |
| 1B   | 256 | 2048 | 2×8         | tight-chord-higham |    785 |   1330 |  211.2 |     2327 | 37.5% |   18879 |
| 8B   |  64 | 2048 | 1×16        | adamw              |   2533 |   4285 |    9.8 |     6830 | 62.5% |   32868 |
| 8B   |  64 | 2048 | 1×16        | tight-chord-higham |   2535 |   4290 |  185.3 |     7012 | 60.8% |   36360 |
| 8B   | 256 | 2048 | 1×16        | adamw              |   3560 |   5400 |   35.1 |     8998 | 50.3% |   40872 |
| 8B   | 256 | 2048 | 1×16        | tight-chord-higham |   3562 |   5402 |  919.3 |     9885 | 45.8% |   54963 |

Source: `logs/bench_profile_packed_v1/blackwell_runs.jsonl`, SLURM job
6364410 (single GPU on workergpu181, n_warmup=2-3, n_cycles=2-3 per cell).
Generated by `scripts/analysis/render_bench_profile_table.py`. Note: the
in-flight bench JSONL was written before the 4N MFU fix landed in code,
so its raw `mfu` field is the inflated 6N value; the renderer applies a
4/6 correction for records lacking `mfu_flops_per_token_per_param`. Once
the next bench reruns under the fixed code, the helper's correction
