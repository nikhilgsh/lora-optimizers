...
Generated by `scripts/analysis/render_bench_profile_table.py`. The JSONL
was rewritten in place to carry corrected 4N MFU values + the
`mfu_flops_per_token_per_param=4.0` field; the bench script now records
this field directly for every new run.
