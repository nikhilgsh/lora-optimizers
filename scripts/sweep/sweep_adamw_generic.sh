#!/bin/bash
# GENERIC AdamW baseline wrapper. Only needed for the empty r128 ladder rung (cell 7);
# every other cell already has AdamW coverage. Parameterized by model / data_dir / lora_r
# as trailing positionals (per-cell in params JSON).
#
