...
\end{cut}
Secondly, we can observe that if we define $\mat{\Sigma}$ to be the second-moment of the gradients and $\|\cdot\|_{\mat{\Sigma}}$ to be the associated Mahalanobis norm
\begin{align}
...
\end{equation}
gives a valid outer-gradient set (\Cref{lem:expectation}).
...
\end{equation}
up to a rescaling of $\tau$. To which a closed form is given by
