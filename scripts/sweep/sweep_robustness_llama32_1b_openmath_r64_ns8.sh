#!/bin/bash
# Robustness pilot: Llama-3.2-1B × OpenMathInstruct-2 (2M subset, column-mapped)
# × seq=2048 × global_batch=16 × r=64 × packed_v1.1.
# ns=8, polar_method=ns (full whitening), picard=1. Clone of
# sweep_robustness_openmath_1b_r64.sh with muon_ns_steps 5 -> 8 and
# --polar_method ns added; mirrors the llama32 r=64 ns=8 reference arm.
# See docs/plans/paper_plan.md and the robustness plan
