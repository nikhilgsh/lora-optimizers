...
The rest of the paper proceeds as follows. In \Cref{sec:sample-loss-lmo} we derive a preconditioned Muon step from per-sample loss control. In \Cref{sec:method} we make it product-aware for LoRA and control the size of the factor updates. All proofs are in \Cref{app:proofs}.
