...
To make the update~\eqref{eq:polora-update} practical for minibatch training, we integrate the following ingredients which results in the \methodname{} step summarized in \Cref{alg:ours}:
